...
S.baseFolder = 'C:\Users\maire\Desktop\behavior Data (lesion exp, --zdrive broken)\testmasterFolder';
...
dateLocation = (underscoreLoc(dateLocation(1))+1):(underscoreLoc(dateLocation(1))+6);
dateOfSes = m1d{1}(dateLocation);
...
%         %%% trials correct vs incorrect (errors) mirror vectors. 
    o(i) = output ;
    o(i).trialResults.Session = m1d{i};
    o(i).trialResults.Date = dateOfSes;
   i
end
