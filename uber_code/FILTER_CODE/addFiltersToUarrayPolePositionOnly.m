%%
function U =  addFiltersToUarrayPolePositionOnly(U)
...
% % % % % % % % % % % % % % %         if ~isempty(firstLickGreaterThan) && firstLickGreaterThan <= (trialLength-winAfterLick) %remove the lick responses that run over 4000 (coul dtrim them but chose not to)
...
% % % % % % % % % % % % % % %     filter6_1 = nanEmpty;
% % % % % % % % % % % % % % %     for k = 1:numTrials
% % % % % % % % % % % % % % %         if (U{cellStep}.meta.poleOffset+addTime) <= trialLength
% % % % % % % % % % % % % % %             filter6_1(U{cellStep}.meta.poleOffset(k):U{cellStep}.meta.poleOffset+addTime(k), k) = 1;
...
% % % % % % % % % % % % % % %                 U{cellStep}.meta.poleOffset+addTimeToOffset+addTime(k), k) = 1;
% % % % % % % % % % % % % % %         elseif  (trialLength - U{cellStep}.meta.poleOffset(k))<smallLimit
% % % % % % % % % % % % % % %             %             disp(['skipping pole down response because less than user selected ', num2str(smallLimit), ' ms']);
% % % % % % % % % % % % % % %         else
...
% % % % % % % % % % % % % % %     
    ...
    numGroups = 40; %num filters in this filter stack
    ...
    for k = 1:numGroups
        ...
        U{cellStep}.filters.filters.polePosition = poleFilt;
...
% % % % % % % % % % % % % %     theseBaslineNumbers = [50 200 400];
