...
for cellNum =3
    ...
    percentToCut=.2;%for scaleing the plot so if .2 then will scale based on withing 80% of trials 
    sortON =1;
    alignON = 1;
...
%placed above percentToCut=.2;
        ...
        otherLicksToPlot = answerLickTimes(var1) -shiftToZero;%##setvar  #firstLicksFinal(var1)' #answerLickTimes(var1)
...
%        [firstlickSorted, firstLickSortInd] = sort(IndicesTrialStart + otherLicksToPlot);
        ...
        [firstlickSorted, firstLickSortInd] = sort(otherLicksToPlot);
        %%%%%%%%%%%%%%%%%%%%%%%%%%%
