...
%     set(gca,'ylim',[0 U{cellNum}.k]+1)
    %% need to copt infor from other program to speed this one up way more 
        for cellNum =[1:3]
     ...
     colorAtEndNumber = 4020:.2:4025;
     colorSet = {'b', 'r', 'g', 'k'};
     
     
     
     text(4300,50, ['cell ', num2str(U{cellNum}.cellNum)])%plot cell number
