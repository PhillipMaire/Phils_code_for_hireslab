...
for cellNum =[1:12]
    ...
    alignON = 1;
    %% search for ##setvar to find variables you mostlikely want to manipulate
    ...
    otherLicksToPlotSet = firstLicksFinal';%##setvar  #firstLicksFinal' #answerLickTimes
    %     ############# this is the new part
