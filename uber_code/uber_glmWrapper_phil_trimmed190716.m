...
for cellStep = 1:length(cellNumsFromWrapper)
    ...
    clearvars -except   allCONTACTS   cellNumberForProject   catchcell k cellNumberForProjectString progressWin3  progressWin2 cellStep ...
        ...
        saveNameTryThisFirst dateString allCellString finalDir U stimTypeToMatch
    ...
    useTrialsSTIM_OFF = find(linIndsToUseTrials==stimTypeToMatch) ;%1 is not stim trials 0 is stim trials (so most likely want it to be 1 unless you are looking at stim trials) 
