...
function poleUP_vs_poleDOWN(U, pole, V, theseCells)
...
supLabel_ALL('Pole up and pole down magnitude comparison','pole up response (Spikes/Sec)','pole down response (Spikes/Sec)','')
% set(gca, 'XScale', 'log')
%%
