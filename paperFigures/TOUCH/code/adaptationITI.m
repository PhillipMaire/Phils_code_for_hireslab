...
for k = theseCells(:)'
    ...
    plot([zeroNum, (betweenEdges{k}(1))],[diff1FT{k}, diff1{k}(1)] , 'o-r', 'LineWidth', 3, 'MarkerFaceColor', 'r');
    
    
    plot(betweenEdges{k}, diff1{k}, '-ok', 'MarkerFaceColor', 'k', 'LineWidth', 3)
    
    axis tight
    linkaxes(s.mainFig.Children(:), 'x')
    plot(xlim, [diff1FT{k},diff1FT{k}], 'r--', 'LineWidth', 3)
