...
touchType = 'all'; % onset offset all
allCellsTouch = {};
[SPout] = SPmaker(5, 9);
[SPout2] = SPmaker(5, 9);
...
for cellStep = theseCells%1:length(U)
    %%
    ...
    %% get the touches
    [~, segments, protractionTouches, touchOrder] = GET_touches(C, touchType, getOnlyFirstTouch);
    allTouches = segments(:, 1);
