...
%%
%%
[DM] = shiftSigWithDM(squeeze(C.S_ctk(1, :, :)), -200:20:200, DM, 'Theta'); 
[DM] = shiftSigWithDM(squeeze(C.S_ctk(2, :, :)), -200:20:200, DM, 'velocity'); 
[DM] = shiftSigWithDM(squeeze(C.S_ctk(3, :, :)), -200:20:200, DM, 'amplitude'); 
[DM] = shiftSigWithDM(squeeze(C.S_ctk(4, :, :)), -200:20:200, DM, 'setpoint'); 
[DM] = shiftSigWithDM(squeeze(C.S_ctk(5, :, :)), -200:20:200, DM, 'phase') ;
[DM] = shiftSigWithDM(squeeze(C.S_ctk(6, :, :)), -200:20:200, DM, 'deltaKappa') ;
[DM] = shiftSigWithDM(squeeze(C.S_ctk(7, :, :)), -200:20:200, DM, 'M0Adj'); 
[DM] = shiftSigWithDM(squeeze(C.S_ctk(8, :, :)), -200:20:200, DM, 'FaxialAdj'); 
%###########################
%###########################
%% set Variable 
