...
startDir = 'C:\testingClass';
 philsClassifier_only_reclassify(startDir)

%}
%% jus to save info, should always be the same
function [] = philsClassifier_only_reclassify(startDir)
...
Lthresh = 50; %length threshold. whisker must be larger than this
