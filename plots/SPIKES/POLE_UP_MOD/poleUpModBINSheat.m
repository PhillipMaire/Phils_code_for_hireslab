...
for varNumber = [3 1 2 4 5 6]
    ...
    for cellStep = 1:length(U)
        ...
        binsForVar = ( round(min(linearALL)) : .2 :  round(max(linearALL)+1 ));
        
        
        
        timeWindow = -50:50;
        
        % %         SPKperBinPRE = nan(length(timeWindow), length(binsForVar) -1);
        % %         SPKperBinSELECTED = SPKperBinPRE;
        % %         normalizeByPRE = SPKperBinPRE;
        % %         normalizeByPOST = SPKperBinPRE;
        SPKperBinSELECTED = nan(length(timeWindow), length(binsForVar) -1);
        ...
        for numberOfSubSelected = 1:2 % post and pre
            ...
            trimmedImage2 = trimmedImage(:,1:40);
            imagesc(trimmedImage2')
            colorbar
        end
        keyboard
        %         figure
        %         temp = bar3(trimmedImage2)
        %         newthing = SPKperBinPOST./normalizeByPOST;
        
        %         save([num2str(varNumber) 'heatmapAMP_' num2str(cellStep) ], 'SPKperBinPOST', 'normalizeByPOST')
        %%
        % % % % % % %          trimmedImage4 = SPKperBinPOST./normalizeByPOST;
        % % % % % % %         test1 = zscore(trimmedImage4);
        % % % % % % %         STDval =2;
        % % % % % % % %         find(test1<-STDval)
        % % % % % % %         test2 = [ find(test1>STDval)];
        % % % % % % %         maskTest2 = ones(size(trimmedImage4));
        % % % % % % %         maskTest2(test2) = 0;
        % % % % % % %         maxInBounds = max(max(trimmedImage4(logical(maskTest2))));
        % % % % % % %
        % % % % % % %         trimmedImage4(test2) = maxInBounds;
        % % % % % % %         figure
        % % % % % % %         imagesc(trimmedImage4)
        %%
        % % % % % % %         figure
        % % % % % % %         xToPlot = reshape(test1, [numel(test1), 1]);
        % % % % % % %         hist(xToPlot, 100)
        %%
        % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
        % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         figure
