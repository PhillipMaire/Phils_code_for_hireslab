...
for cellStep = 1:length(U)
    ...
    for k = 1:length(poleONSETS)
        ...
        firstSpikesTMP_BL = find(spikesTMP(eventStartTime_BL:end, k), 1);
    ...
    xlimSET2 = [];
    xlimSET2(1) = xlimSET_BL(1) - xPosForNoWhisk.*2;
...
% keyboard
set(gcf, 'Units', 'Normalized', 'OuterPosition', [1, 0, 1, 1]);
filename =  [num2str(cellStep), '_1st_spkAfterPole_andBeforePole' ];
